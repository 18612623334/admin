...
<div class="mod-notfound grid-98"><IMG class=img-notfound height=320 src="{{asset('style/files/notfound.gif')}}" width=520>
<P style="FONT-SIZE: 24px; LINE-HEIGHT: 70px">啊~哦~ 您要查看的页面不存在哦！</P>
<P style="MARGIN-BOTTOM: 30px">请检查您的路由是否正确</P>
</body></HTML>
